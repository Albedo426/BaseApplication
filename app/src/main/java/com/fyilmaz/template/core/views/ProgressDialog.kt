package com.fyilmaz.template.core.views
...
import com.fyilmaz.template.databinding.ProgressDialogBinding
import java.util.*
...
class ProgressDialog @JvmOverloads constructor(
    ...
    constructor(context: Context, @ThemeConstant themeConstant: Int = THEME_LIGHT) :
        this(
            modeConstant = MODE_INDETERMINATE,
            context = context,
    ...
    fun hasSecondaryProgressReachedMaxValue(): Boolean =
        if (isDeterminate) secondaryProgress == maxValue else false
